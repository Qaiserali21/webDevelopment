        ...
        <div class="w-100">
            <div class="card mt-5 mb-0">
                <div id="surveyElement" class="itl-survey" style="display:inline-block;width:100%;">
                    ...
                      <label for="html" class="mb-2" style="cursor: pointer;"><a href="consultation10.php" style="color: #938977;">Normal 90/60 to 139/89</a></label>
                        <br>
                      <input type="radio" id="css" name="fav_language" value="CSS" class="female">
                      <label for="css" style="cursor: pointer;"><a href="consultation9.php" style="color: #938977;">High 140/90 or above</a></label><br>
                    <input type="radio" id="html" name="fav_language" value="HTML" class="mb-3 mt-3">
                      <label for="html" class="mb-2" style="cursor: pointer;"><a href="consultation10.php" style="color: #938977;">Low 90/60 or below</a></label><br> 
