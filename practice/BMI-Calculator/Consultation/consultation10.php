        ...
        <div class="w-100">
            <div class="card mt-5 mb-0">
                <div id="surveyElement" class="itl-survey" style="display:inline-block;width:100%;">
                    <legend>
                        ...
                        <p class="mt-2">We recommend all patients struggling with weight management<br> have their blood sugar measured at least every 6 months. The<br> reading is known as HbA1c.</p>
                    </legend>
                    <input type="radio" id="html" name="fav_language" value="HTML" class="mb-3 mt-4">
                      <label for="html" class="mb-2" style="cursor: pointer;"><a href="consultation11.php" style="color: #938977;">Yes- I know the reading</a></label>
                        <br>
                      <input type="radio" id="css" name="fav_language" value="CSS" class="female">
                      <label for="css" style="cursor: pointer;"><a href="consultation12.php" style="color: #938977;">Yes- I do not know the reading</a></label><br>
                    <input type="radio" id="html" name="fav_language" value="HTML" class="mb-3 mt-3">
                      <label for="html" class="mb-2" style="cursor: pointer;"><a href="consultation12.php" style="color: #938977;">No- I have not had my blood sugar measured</a></label>   
            ...
            <div class="itl-survey__progressbar my-4">
                <div id="chatbot-progressbar" role="progressbar" aria-valuemin="0" class="ui-progressbar ui-corner-all ui-widget ui-widget-content" aria-valuemax="100%" aria-valuenow="26%">
                    ...
                    <span id="progressbarval" class="value">26%</span>
