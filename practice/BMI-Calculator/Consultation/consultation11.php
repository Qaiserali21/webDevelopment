        ...
        <div class="w-100">
            <div class="card mt-5 mb-0">
                <div id="surveyElement" class="itl-survey" style="display:inline-block;width:100%;">
                    ...
                      <label for="html" class="mb-2" style="cursor: pointer;"><a href="consultation12.php" style="color: #938977;">Below or equal to 7.8 mmol/L</a></label>
                        <br>
                      <input type="radio" id="css" name="fav_language" value="CSS" class="female">
                      <label for="css" style="cursor: pointer;"><a href="consultation12.php" style="color: #938977;">Above 7.8mmol/L</a></label><br> 
