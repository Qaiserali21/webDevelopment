        ...
        <div class="w-100">
            <div class="card mt-5 mb-0">
                <div id="surveyElement" class="itl-survey" style="display:inline-block;width:100%;">
                    ...
                      <label for="html" class="mb-2" style="cursor: pointer;">No</label>
                        <br>
                      <input type="radio" id="css" name="fav_language" value="CSS" class="female">
                      <label for="css" style="cursor: pointer;"><a href="consultation8.php" style="color: #938977;">Yes</a></label>
            ...
            <div class="itl-survey__progressbar my-4">
                <div id="chatbot-progressbar" role="progressbar" aria-valuemin="0" class="ui-progressbar ui-corner-all ui-widget ui-widget-content" aria-valuemax="100%" aria-valuenow="13%">
                    <span id="chatbot-progressbar__value" style="width: 13%;">
                    <span id="progressbarval" class="value">13%</span>
                     %
                    </span>
                    <div class="ui-progressbar-value ui-corner-left ui-widget-header" style="width: 13%;"></div>
                </div>
            </div>
        </div>
    </div>
