            ...
            <div class="card mt-5 mb-0">
                <div id="surveyElement" class="itl-survey" style="display:inline-block;width:100%;">
                    <legend>
                        ...
                        <p class="mt-2" style="color: #4DC4D8;">If you struggle with weight management, we advise to have your<br> blood pressure checked at least every 6 months with your NHS<br> GP.</p>
                    </legend>
                    <input type="radio" id="html" name="fav_language" value="HTML" class="mb-3 mt-4">
                      <label for="html" class="mb-2">Yes- I know the reading</label>
                        <br>
                      <input type="radio" id="css" name="fav_language" value="CSS" class="female">
                      <label for="css" style="cursor: pointer;"><a href="consultation10.php" style="color: #938977;">Yes- I do not know the reading</a></label><br>
                    <input type="radio" id="html" name="fav_language" value="HTML" class="mb-3 mt-3">
                      <label for="html" class="mb-2">No- I have not had my blood pressure measured</label>   
                    <div class="card-content pt-0 justify-content-center d-flex pb-4 mt-5">
                        <a href="consultation7.php"><button id="proceedBtn" class="proceedBtn">Next</button></a>
                    </div>
                </div>
            </div>
            <div class="itl-survey__progressbar my-4">
                <div id="chatbot-progressbar" role="progressbar" aria-valuemin="0" class="ui-progressbar ui-corner-all ui-widget ui-widget-content" aria-valuemax="100%" aria-valuenow="17%">
                    <span id="chatbot-progressbar__value" style="width: 17%;">
                    <span id="progressbarval" class="value">17%</span>
                     
                    </span>
                    <div class="ui-progressbar-value ui-corner-left ui-widget-header" style="width: 17%;"></div>
                </div>
            </div>
        </div>
    </div>
