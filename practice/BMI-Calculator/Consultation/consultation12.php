        ...
        <div class="w-100">
            <div class="card mt-5 mb-0">
                <div id="surveyElement" class="itl-survey" style="display:inline-block;width:100%;">
                    ...
                      <label for="html" class="mb-2" style="cursor: pointer;"><a href="consultation13.php" style="color: #938977;">No - No medical conditions</a></label>
                        <br>
                      <input type="radio" id="css" name="fav_language" value="CSS" class="female">
                      <label for="css" style="cursor: pointer;"><a href="consultation14.php" style="color: #938977;">Diabetes</a></label><br>

                    <input type="radio" id="html" name="fav_language" value="HTML" class="mb-3 mt-3">
                      <label for="html" class="mb-2" style="cursor: pointer;"><a href="consultation14.php" style="color: #938977;">Pancreatitis</a></label>
                        <br>
                      <input type="radio" id="css" name="fav_language" value="CSS" class="female">
                      <label for="css" style="cursor: pointer;"><a href="template14.html" style="color: #938977;">Inflamed gall bladder or gallstones</a></label><br>
                    <input type="radio" id="html" name="fav_language" value="HTML" class="mb-3 mt-3">
                      <label for="html" class="mb-2" style="cursor: pointer;"><a href="consultation14.php" style="color: #938977;">Heart failure, heart attack or stroke</a></label>
                        <br>
                    <input type="radio" id="html" name="fav_language" value="HTML" class="mb-3 mt-1">
                    <label for="html" class="mb-2" style="margin-left: 10px; cursor: pointer;"><a href="consultation14.php" style="color: #938977;">Ketoacidosis</a></label>
                            <br>
                    <input type="radio" id="css" name="fav_language" value="CSS" class="female" style="margin-left: 2px;">
                    <label for="css" style="margin-left: 10px; cursor: pointer;"><a href="consultation14.php" style="color: #938977;">Inflammatory bowel disease i.e. Ulcerative</a></label><br>
                    <input type="radio" id="html" name="fav_language" value="HTML" class="mb-3 mt-3">
                    <label for="html" class="mb-2" style="margin-left: 10px; cursor: pointer;"><a href="consultation14.php" style="color: #938977;">Personal or Family history of Medullary thyroid</a></label>
                            <br>
                    <input type="radio" id="css" name="fav_language" value="CSS" class="female" style="margin-left: 2px;">
                    <label for="css" style="margin-left: 10px; cursor: pointer;"><a href="consultation14.php" style="color: #938977;">Hormone Condition</a></label><br>
                    <input type="radio" id="html" name="fav_language" value="HTML" class="mb-3 mt-3" style="margin-left: 2px;">
                    <label for="html" class="mb-2" style="margin-left: 10px; cursor: pointer;"><a href="consultation14.php" style="color: #938977;">Other</a></label>
                            <br>
            ...
            <div class="itl-survey__progressbar my-4">
                <div id="chatbot-progressbar" role="progressbar" aria-valuemin="0" class="ui-progressbar ui-corner-all ui-widget ui-widget-content" aria-valuemax="100%" aria-valuenow="29%">
                    <span id="chatbot-progressbar__value" style="width: 29%;">
                    <span id="progressbarval" class="value">29%</span>
                     
                    </span>
                    <div class="ui-progressbar-value ui-corner-left ui-widget-header" style="width: 29%;"></div>
                </div>
            </div>
        </div>
    </div>
