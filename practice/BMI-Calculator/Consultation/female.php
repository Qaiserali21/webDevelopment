...
<div class="page-wrapper" style="background: #5E7BC0;"><main id="maincontent" class="page-main"><a id="contentarea" tabindex="-1"></a>
            ...
            <div class="card mt-5 mb-0">
                <div id="surveyElement" class="itl-survey" style="display:inline-block;width:100%;">
                    ...
                    <div class="card-content pt-0 justify-content-center d-flex pb-4 mt-5">
                        <button id="proceedBtn" class="proceedBtn">Next</button>
                    </div>
                </div>
            </div>
