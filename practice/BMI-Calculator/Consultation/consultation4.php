        ...
        <div class="w-100">
            <div class="card mt-5 mb-0">
                <div id="surveyElement" class="itl-survey" style="display:inline-block;width:100%;">
                    <legend>
                        <h3 style="font-weight: 700; color: #5E7BC0;">Could you please indicate a general well being<br> score? How well do you feel generally speaking</h3>
                        <!-- <p>It is important we understand the motives for trying to mange<br> your weight as this can dictate the type of treatment plan we<br> offer and more specifically the advice we give you for length of<br> treatment and goals.</p> -->
                    </legend>
                    <input type="radio" id="html" name="fav_language" value="HTML" class="mb-3 mt-5">
                      <label for="html" class="mb-2"><img src="img/img2.png" alt="" style="width: 15px;vertical-align: bottom;margin-right: 5px;margin-top: 10px;margin-bottom: 15px;"> Unhappy</label>
                        <br>
                      <input type="radio" id="css" name="fav_language" value="CSS" class="female">
                      <label for="css"><img src="img/img1.png" alt="" style="width: 15px;vertical-align: bottom;margin-right: 5px;margin-top: 10px;margin-bottom: 5px;">Neutral</label><br>

                    <input type="radio" id="html" name="fav_language" value="HTML" class="mb-3 mt-3">
                      <label for="html" class="mb-2"><img src="img/img3.png" alt="" style="width: 15px;vertical-align: bottom;margin-right: 5px;margin-top: 25px;margin-bottom: 15px;">Happy</label>
                        <br>
                    <div class="card-content pt-0 justify-content-center d-flex pb-4 mt-5">
                        <a href="consultation5.php"><button id="proceedBtn" class="proceedBtn">Next</button></a>
                    </div>
                </div>
            </div>
