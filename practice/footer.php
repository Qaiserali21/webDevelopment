        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-sm-12 col-md-6 col-lg-6">
              <span class="fz-14">&copy; Design And Develop by Tech solutions Pro, All Rights Reserved.</span>
              <a class="fz-14 color-primary" href="https://techsolutionspro.co.uk/">Techsolutionspro</a>
            </div><!-- /.col-lg-6 -->
            <div class="col-sm-12 col-md-6 col-lg-6">
              <nav>
