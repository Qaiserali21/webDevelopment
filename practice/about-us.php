      ...
      <nav class="navbar navbar-expand-lg sticky-navbar">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.php">
            ...
            <img src="assets/images/Weighloss_final_logo.png" class="logo-dark" width="110px" height="110px" alt="logo">
          </a>
          ...
          <div class="collapse navbar-collapse" id="mainNavigation">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav__item has-dropdown">
                <a href="about-us.php" data-toggle="dropdown" class="dropdown-toggle nav__item-link active">About Us</a>
                <!-- /.dropdown-menu -->
              </li><!-- /.nav-item -->
              <!-- /.nav-item -->
              <li class="nav__item has-dropdown">
